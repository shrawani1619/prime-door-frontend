...
const quickLinks = [
  ...
  { to: '/portal/login', label: 'Customer Portal Login' },
];

const productLinks = [
  { to: '/products', label: 'All Products' },
  { to: '/services/commercial', label: 'Commercial Doors' },
  { to: '/services/commercial', label: 'Dock Equipment' },
  { to: '/services/residential', label: 'Residential Doors' },
  { to: '/services/emergency', label: 'Emergency Repair' },
];

const serviceLinks = [
  { to: '/services/commercial', label: 'Commercial Services' },
  { to: '/services/residential', label: 'Residential Services' },
  { to: '/services/emergency', label: 'Emergency Repair' },
  { to: '/services/maintenance', label: 'Maintenance Programs' },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-6 max-w-sm">
              10+ years serving New Jersey with commercial dock, overhead door, and residential
              garage door services. Your trusted partner for industrial door solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="leading-relaxed">
                Serving Bergen, Hudson, Essex, Passaic, Union & Middlesex Counties
              </li>
            </ul>

            <h4 className="text-white font-semibold mt-6 mb-3 text-sm uppercase tracking-wider">Services</h4>
